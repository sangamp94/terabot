...
def upload_to_pixeldrain(filepath):
    print(f"[+] Uploading {filepath} to Pixeldrain...")
...
def run_grab(channel_id, date_str, time_str, duration, output_ext, channels):
...
if __name__ == "__main__":
    if len(sys.argv) == 1:
        ...
        channels = fetch_channels_from_m3u()
        channel_id, date_str, time_str, duration_str, output_ext = sys.argv[1:]
        run_grab(channel_id, date_str, time_str, duration_str, output_ext, channels)
    else:
